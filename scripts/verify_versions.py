#!/usr/bin/env python3
"""Verify that the bankstatementparser-lsp package version is in lockstep everywhere.

Single source of truth: ``bankstatementparser_lsp.__version__``. This script reads
...
def _package_version() -> str:
    ...
    import bankstatementparser_lsp  # noqa: E402  (path-dependent import)

    return bankstatementparser_lsp.__version__
...
def main() -> int:
    ...
    print(f"  bankstatementparser_lsp.__version__   = {pkg}")
